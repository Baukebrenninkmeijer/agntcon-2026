...
- Replace the current slide titled **One case through the full loop**. The deck remains at 18
...
- Regenerate the HTML deck and confirm it contains exactly 18 slides.
