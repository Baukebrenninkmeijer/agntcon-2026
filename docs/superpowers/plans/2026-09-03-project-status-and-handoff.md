...
3. After that dependency is pinned and verified offline, align `story-outline.md` and `outline.md` to the analytics-only decision-support narrative and record fresh repository evidence.
