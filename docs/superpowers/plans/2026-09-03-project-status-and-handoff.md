...
|---|---|---|---|
| 2026-09-05 (8, latest) | WS5 | Investigated staging as a possible BOPS-1180 validation target, but staging ingress does not allowlist the operator IP. Explicitly kept the workflow production-only; no staging project, credential, or profile-switch implementation was created | Wait for the production BOPS-1180 release, then validate one fresh uniquely named Experiment in `pydata2026` |
