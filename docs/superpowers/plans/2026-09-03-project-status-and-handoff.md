...
| Hosted resources | `ACTIVE` | The historical hosted agent/tool path and `analytics-answer-correctness@1.0.8` apply are verified, but the four old subjective YAML definitions have not yet been replaced by Task 4's single local `decision_support_quality` definition. No hosted apply is authorized | Implement and verify Task 4 locally, preserve remote correctness resources as historical state, and do not apply the new jury |
...
3. Update WS3a resource schemas/transformation/sync for the agent, tools, retained historical deterministic definitions, and Task 4's single subjective jury definition. Remove the tracked project ID and review a fresh unified semantic plan; no hosted apply is authorized by this increment.
