...
__FONT_FACES__
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .twin-card.unknown{border-color:var(--muted)}
  ...
  .twin-unknown{height:150px;display:grid;place-items:center;font-size:144px;line-height:1;font-weight:600;color:var(--muted)}
...
<section class="slide hands-slide" data-steps="3">
  ...
  <ol>
    ...
    <li class="later"><span class="n">02</span>Who has a regression dataset for your AI<br>applications that is ran on changes?</li>
...
<section class="slide">
  ...
  <div class="compare">
    ...
    <div class="answer b">
      ...
      <p><strong>Two streets to your left</strong>, about five minutes on foot.</p>
    </div>
  </div>
</section>
...
<section class="slide" data-steps="1">
  ...
  <div class="twin">
    <div class="twin-card ok">
      ...
      <div class="twin-verdict"><b>Holding</b><span>the human-aligned criterion still passes</span></div>
    </div>
    <div class="twin-card unknown">
      <div class="twin-lab">Factory B</div>
      <div class="twin-gauge"><i></i></div>
      <p class="twin-caption">Most pull requests merge untouched.</p>
      <div class="twin-rule"></div>
      <div class="twin-unknown" aria-label="Human alignment unverified">?</div>
      <div class="twin-axes"><span>Human alignment</span><span>Unverified</span></div>
      <div class="twin-verdict"><b>Unknown</b><span>the criterion has not been checked against humans</span></div>
    </div>
  </div>
